...
Diffbot.prototype.product = function (options, callback) {
  ...
  var diffbot_url = "http://api.diffbot.com/v3/product?token=" + this.token + "&url=" + encodeURIComponent(options.uri);
